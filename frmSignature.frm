...
Begin VB.Form frmSignature 
   ...
   Begin VB.TextBox txtPath 
      ...
      Width           =   5565
   End
   Begin BeetleAV.ShapeButton cmdOpen 
      Height          =   375
      Left            =   4455
      TabIndex        =   0
      Top             =   2400
      ...
      EndProperty
   End
   Begin BeetleAV.ShapeButton cmdClear 
      Height          =   375
      Left            =   150
      TabIndex        =   1
      Top             =   3375
      ...
      CaptionAlignment=   3
      PictureAlignment=   1
      BackColorPressed=   11504768
      BackColorHover  =   11969951
      ...
      EndProperty
   End
   Begin BeetleAV.ShapeButton cmdAddDB 
      Height          =   375
      Left            =   1665
      TabIndex        =   2
      Top             =   3375
      ...
      EndProperty
   End
   Begin BeetleAV.ShapeButton cmdClose 
      Height          =   375
      Left            =   3855
      TabIndex        =   6
      Top             =   3375
